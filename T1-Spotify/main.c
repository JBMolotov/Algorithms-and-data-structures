...
void LerDados(Lista* spotify, FILE *fb)
{
    ...
    char track_name[50], track_id[501], album_name[50], album_id[50], artist_name[50], artist_id[50], release_date[50], length[50], popularity[50], acousticness[50], danceability[50], energy[50], instrumentalness[50], liveness[50], loudness[50], speechiness[50], tempo[50], time_signature[50];
